...
export const pricingCostAction = (pricingRuleId,startTime, endTime)=>async(dispatch) => {
	...
	try {
		const options = {
			...
			url: `${API_URL}/api/v1/costByPricingRule?ids=${pricingRuleId}&startTime=${startTime}&endTime=${endTime}&isMultiple=false&daysList=`,
